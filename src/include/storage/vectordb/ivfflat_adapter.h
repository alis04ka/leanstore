...
struct VectorAdapter {
 ...
 public:
  ...
  // -------------------------------------------------------------------------------------
  void Scan(const VectorRecord::Key &key,
            const FoundVectorFunc& found_db);
  void ScanDesc(const VectorRecord::Key &key, const FoundVectorFunc &found_record_cb);
  void ScanCentroids(const VectorRecord::Key &key,
            const FoundVectorFunc& found_db);
  void ScanCentroidsDesc(const VectorRecord::Key &key,
                const FoundVectorFunc &found_record_cb);
