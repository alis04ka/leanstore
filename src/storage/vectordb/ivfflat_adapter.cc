...
auto VectorAdapter::CountMain() -> u64 { return tree_->CountEntries(); }

auto VectorAdapter::CountCentroids() -> u64 { return centroid_tree_->CountEntries(); }
...
void VectorAdapter::RemoveBlob(leanstore::BlobState *state) { db_->RemoveBlob(state); }
